...
from TPS_transformer import transformer
import numpy as np
...
h_trans = transformer(x_tensor, x, out_size, Column_controlP_number,Row_controlP_number)
...
file_writer = tf.summary.FileWriter('./TestGraph', sess.graph)
#tf.summary.FileWriter('./my_graph', model.sess.graph) 
